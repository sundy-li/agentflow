...
Use git worktree to create a dedicated worktree for this task, new branch should be follow `{REPO_DIR}/.worktrees/pr-fix-{ISSUE_NUMBER}`. Create and use a fresh branch inside that worktree so multiple tasks can run in parallel safely.
