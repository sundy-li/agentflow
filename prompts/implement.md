...
Use git worktree to create a dedicated worktree for this task. Create and use a fresh branch inside that worktree so multiple tasks can run in parallel safely.
